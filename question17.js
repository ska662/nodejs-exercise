...
"articles": [
 {
"author": "Bryan Clark",
"titl": "Spotify is using billboards to call users out on their questionable listening habits",
...
{
"author": "Bryan Clark",
"titl": "Man in VR headset falls off fake cliff and hits a very real floor",
...
"publishedAt": "2016-11-30T00:00:30Z"
 ...
 {
"author": "Napier Lopez",
"titl": "Microsoft's new app tries to fix Android's copy and paste problem",
...
"publishedAt": "2016-11-29T22:11:20Z"
 ...
 {
"author": "Bryan Clark",
"titl": "Dueling smart assistants give zero fucks about your calendar",
...
"publishedAt": "2016-11-29T21:44:47Z"
 ...
 {
"author": "Bryan Clark",
"titl": "This Chrome extension replaces 'alt-right' with 'white supremacist'",
...
{
"author": "Juan Buis",
"titl": "Disney's new animatronic robots are getting too realistic for me",
...
//console.log(JSON.stringify(obj.articles.author,null,4));

var myobj = jsonStr.articles;
var res = [];
for (var i = 0; i < myobj.length; i++) {
	var obj = {author:myobj[i].author,title:myobj[i].titl,description:myobj[i].description};
	res.push(obj);
}
